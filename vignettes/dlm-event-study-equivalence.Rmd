...
endpoints. This package implements their method and is based in part
on their replication code. The key result is that event-study
coefficients can be recovered from DLM coefficients via cumulative
summation, and the two approaches yield identical estimates and
standard errors when applied to the same sample.
